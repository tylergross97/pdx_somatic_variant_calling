process ACCESSORY_FILES_DOWNLOAD {
    ...
    stub:
    """
    touch Homo_sapiens_assembly38.dbsnp138.vcf
    touch Homo_sapiens_assembly38.dbsnp138.vcf.idx
    touch Homo_sapiens_assembly38.known_indels.vcf.gz
    touch Homo_sapiens_assembly38.known_indels.vcf.gz.tbi
    touch Mills_and_1000G_gold_standard.indels.hg38.vcf.gz
    touch Mills_and_1000G_gold_standard.indels.hg38.vcf.gz.tbi
    touch af-only-gnomad.hg38.vcf.gz
    touch af-only-gnomad.hg38.vcf.gz.tbi
    touch small_exac_common_3.hg38.vcf.gz
    touch small_exac_common_3.hg38.vcf.gz.tbi
    touch 1000g_pon.hg38.vcf.gz
    touch 1000g_pon.hg38.vcf.gz.tbi
    """
}
